<script>
	export let data = {
		...
		subtitle: 'This is a alert subtitle'
	};
</script>

<div id="index-alert" class="p-4 mb-4 text-indigo-200 rounded-lg rounded-l-none bg-gray-800 border-l-8 border-indigo-600" role="alert">
