	...
	<footer class="text-gray-400 bg-gray-900 body-font md:opacity-30 hover:opacity-100 transition-opacity duration-500">
		<div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
			...
			<span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
				<a
					sveltekit:prefetch
					href="mailto:parapallidev+linkte@gmail.com"
					target="_blank"
					class="text-gray-400 hover:text-green-300 active:text-green-500 transition-all duration-200">
					<svg
						class="w-5 h-5"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink"
				...
				<a
					...
					target="_blank"
					class="ml-3 text-gray-400 hover:text-green-300 active:text-green-500 transition-all duration-200">
					<svg
						class="w-5 h-5"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink"
				...
				<a
					sveltekit:prefetch
					href="https://wa.me/+918793150182?text=Hello!"
					target="_blank"
					class="ml-3 text-gray-400 hover:text-green-300 active:text-green-500 transition-all duration-200">
					<svg
						class="w-5 h-5"
